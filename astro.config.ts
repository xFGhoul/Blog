...
export default defineConfig({
	site: siteConfig.url,
	image: {
		domains: ["cdn.ghoul.cloud", "avatars.githubusercontent.com"],
	},
	integrations: [
		...
		webmanifest({
			...
			short_name: "Blog", // optional
			description: siteConfig.description,
			lang: siteConfig.lang,
			icon: "public/icon.svg", // The source for generating favicon & icons
			icons: [
				{
					src: "public/apple-touch-icon.png", // Used in src/components/BaseHead.astro L:26
					sizes: "180x180",
					type: "image/png",
				},
				{
